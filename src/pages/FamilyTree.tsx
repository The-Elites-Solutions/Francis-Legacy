...
export default function FamilyTree() {
  ...
  return (
    <div className="min-h-screen py-4 sm:py-6 lg:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 sm:mb-4">
            Family <span className="text-yellow-400">Tree</span>
          </h1>
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
          <div className="relative w-full max-w-sm sm:max-w-md">
            ...
            <Input
              ...
              className="pl-10 bg-gray-900/50 border-yellow-400/20 text-white placeholder-gray-400 h-11 text-base touch-manipulation"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-gray-900/30 py-6 sm:py-8 lg:py-12 mb-6 sm:mb-8">
        <div className="max-w-full">
          <div className="w-full px-3 sm:px-6 lg:px-8">
            <Card className="bg-gray-900/50 border-yellow-400/20">
              <CardHeader className="text-center px-3 sm:px-6 py-4 sm:py-6">
                <CardTitle className="text-white flex items-center justify-center text-lg sm:text-xl">
                  <User className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-yellow-400" />
              ...
              <CardContent className="p-3 sm:p-6 lg:p-8">
                <div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  ...
                  <div className="text-center">
                    <h3 className="text-base sm:text-lg font-semibold text-yellow-400 mb-4 sm:mb-6 lg:mb-8">
                    ...
                    <div className="flex justify-center">
                      ...
                      >
                        <Avatar className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 mb-2 sm:mb-3 ring-2 sm:ring-3 ring-yellow-400/50 group-hover:ring-yellow-400 group-active:ring-yellow-400 transition-all">
                          <AvatarImage src={familyData[0].photo} />
                          <AvatarFallback className="bg-yellow-400/20 text-yellow-400 text-lg sm:text-xl">
                            {familyData[0].name.charAt(0)}
                          </AvatarFallback>
                        </Avatar>
                        <span className="text-white text-sm sm:text-base font-medium group-hover:text-yellow-400 transition-colors text-center max-w-24 sm:max-w-none">
                          {isMobile ? familyData[0].name.split(' ')[0] : familyData[0].name}
                        </span>
                        <span className="text-gray-400 text-xs sm:text-sm">
                          {familyData[0].birth} - {familyData[0].death}
                        </span>
                        <span className="text-yellow-400 text-xs mt-1 text-center max-w-20 sm:max-w-none leading-tight">
                  ...
                  <div className="flex justify-center my-4 sm:my-6 lg:my-8">
                    <div className="relative w-[200px] sm:w-[250px] lg:w-[300px]">
                      <div className="h-8 sm:h-12 lg:h-16 w-0.5 bg-gradient-to-b from-yellow-400 to-yellow-600 mx-auto"></div>
                      <div className="absolute top-4 sm:top-6 lg:top-8 left-1/2 transform -translate-x-1/2 w-full h-0.5 bg-gradient-to-r from-yellow-400/0 via-yellow-400 to-yellow-400/0"></div>
                      <div className="absolute top-4 sm:top-6 lg:top-8 left-0 w-0.5 h-4 sm:h-6 lg:h-8 bg-yellow-400"></div>
                      <div className="absolute top-4 sm:top-6 lg:top-8 right-0 w-0.5 h-4 sm:h-6 lg:h-8 bg-yellow-400"></div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 pb-2">
                      {familyData.filter(member => member.parents?.includes('1')).map((member) => (
                        <div 
                          ...
                          style={{ minWidth: '44px', minHeight: '44px' }}
                        >
                          <Avatar className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mb-2 sm:mb-3 ring-2 ring-yellow-400/50 group-hover:ring-yellow-400 group-active:ring-yellow-400 transition-all">
                            <AvatarImage src={member.photo} />
                            <AvatarFallback className="bg-yellow-400/20 text-yellow-400 text-sm sm:text-base">
                              {member.name.charAt(0)}
                            </AvatarFallback>
                          </Avatar>
                          <span className="text-white text-xs sm:text-sm font-medium group-hover:text-yellow-400 transition-colors text-center max-w-16 sm:max-w-20 lg:max-w-24 leading-tight">
                            {isMobile ? member.name.split(' ')[0] : member.name}
                          </span>
                          <span className="text-gray-400 text-xs leading-tight">
                            {member.birth} - {member.death}
                          </span>
                          <span className="text-yellow-400 text-xs mt-1 text-center max-w-16 sm:max-w-18 lg:max-w-20 leading-tight">
                            {isMobile 
                  ...
                  <div className="flex justify-center">
                    <div className="h-6 sm:h-8 lg:h-12 w-0.5 bg-yellow-400/50"></div>
                  </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 pb-2">
                      {familyData.filter(member => member.parents?.includes('2')).map((member) => (
                        <div 
                          ...
                          style={{ minWidth: '44px', minHeight: '44px' }}
                        >
                          <Avatar className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 mb-2 ring-2 ring-yellow-400/50 group-hover:ring-yellow-400 group-active:ring-yellow-400 transition-all">
                            <AvatarImage src={member.photo} />
                            <AvatarFallback className="bg-yellow-400/20 text-yellow-400 text-xs sm:text-sm">
                              {member.name.charAt(0)}
                            </AvatarFallback>
                          </Avatar>
                          <span className="text-white text-xs sm:text-sm font-medium group-hover:text-yellow-400 transition-colors text-center max-w-14 sm:max-w-16 lg:max-w-20 leading-tight">
                            {isMobile ? member.name.split(' ')[0] : member.name}
                          </span>
                          <span className="text-gray-400 text-xs leading-tight">
                            {member.birth} - {member.death}
                          </span>
                          <span className="text-yellow-400 text-xs mt-1 text-center max-w-14 sm:max-w-16 lg:max-w-20 leading-tight">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          <Card className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border-yellow-400/30 text-center touch-manipulation">
            <CardContent className="pt-4 sm:pt-6 pb-4 sm:pb-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-400 mb-1 sm:mb-2">127</div>
              <div className="text-gray-300 text-xs sm:text-sm lg:text-base">Total Members</div>
            </CardContent>
          </Card>
          
          <Card className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border-yellow-400/30 text-center touch-manipulation">
            <CardContent className="pt-4 sm:pt-6 pb-4 sm:pb-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-400 mb-1 sm:mb-2">6</div>
              <div className="text-gray-300 text-xs sm:text-sm lg:text-base">Generations</div>
            </CardContent>
          </Card>
          
          <Card className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border-yellow-400/30 text-center touch-manipulation">
            <CardContent className="pt-4 sm:pt-6 pb-4 sm:pb-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-400 mb-1 sm:mb-2">18</div>
              <div className="text-gray-300 text-xs sm:text-sm lg:text-base">Countries</div>
            </CardContent>
          </Card>
          
          <Card className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border-yellow-400/30 text-center touch-manipulation">
            <CardContent className="pt-4 sm:pt-6 pb-4 sm:pb-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-400 mb-1 sm:mb-2">1848</div>
              <div className="text-gray-300 text-xs sm:text-sm lg:text-base">Earliest Record</div>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="w-[95vw] sm:w-[85vw] md:w-[75vw] lg:w-[65vw] xl:max-w-4xl max-h-[85vh] sm:max-h-[80vh] overflow-y-auto bg-gray-900 border-yellow-400/30 text-white mx-2 sm:mx-auto">
          {selectedMemberData && (
            <>
              <DialogHeader className="pb-4 sm:pb-6">
                <DialogTitle className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 text-xl sm:text-2xl text-yellow-400">
                  <Avatar className="w-12 h-12 sm:w-16 sm:h-16 ring-2 ring-yellow-400 flex-shrink-0">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <div className="text-gray-400 text-sm sm:text-base font-normal">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      <h4 className="text-yellow-400 font-semibold mb-2 text-base sm:text-lg">Basic Information</h4>
                      <div className="space-y-2 text-sm sm:text-base">
                        {selectedMemberData.occupation && (
                          <div className="flex items-start space-x-2">
                            <User className="w-4 h-4 text-yellow-400 mt-0.5 flex-shrink-0" />
                            <span className="leading-tight">{selectedMemberData.occupation}</span>
                          </div>
                        )}
                        {selectedMemberData.birthLocation && (
                          <div className="flex items-start space-x-2">
                            <MapPin className="w-4 h-4 text-yellow-400 mt-0.5 flex-shrink-0" />
                            <span className="leading-tight">Born in {selectedMemberData.birthLocation}</span>
                          </div>
                        )}
                        {selectedMemberData.deathLocation && (
                          <div className="flex items-start space-x-2">
                            <MapPin className="w-4 h-4 text-yellow-400 mt-0.5 flex-shrink-0" />
                            <span className="leading-tight">Died in {selectedMemberData.deathLocation}</span>
                          </div>
                        )}
                        {selectedMemberData.spouse && (
                          <div className="flex items-start space-x-2">
                            <Heart className="w-4 h-4 text-yellow-400 mt-0.5 flex-shrink-0" />
                            <span className="leading-tight">Married to {selectedMemberData.spouse}</span>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      <h4 className="text-yellow-400 font-semibold mb-2 text-base sm:text-lg">Family Connections</h4>
                      <div className="space-y-2 text-sm sm:text-base">
                        {selectedMemberData.parents && selectedMemberData.parents.length > 0 && (
                          <div>
                            <span className="text-yellow-400 font-medium">Parents:</span>{' '}
                ...
                {selectedMemberData.biography && (
                  <div>
                    <h4 className="text-yellow-400 font-semibold mb-2 text-base sm:text-lg">Life Story</h4>
                    <p className="text-gray-300 leading-relaxed text-sm sm:text-base">{selectedMemberData.biography}</p>
                  </div>
                )}
                ...
                {selectedMemberData.achievements && selectedMemberData.achievements.length > 0 && (
                  <div>
                    <h4 className="text-yellow-400 font-semibold mb-2 text-base sm:text-lg">Notable Achievements</h4>
                ...
                {selectedMemberData.memories && (
                  <div className="pb-2">
                    <h4 className="text-yellow-400 font-semibold mb-2 text-base sm:text-lg">Family Memories</h4>
                    <p className="text-gray-300 leading-relaxed italic text-sm sm:text-base">"{selectedMemberData.memories}"</p>
                  </div>
                )}
              </div>
            </>
