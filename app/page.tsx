        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Welcome to our digital family heritage collection. Explore generations of stories, 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold" asChild>
                <Link href="/family-tree" className="flex items-center">
                  Explore Family Tree
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black" asChild>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Navigate through different sections of our family collection to uncover stories, 
      ...
      <section className="py-20 bg-gray-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Recent Family Updates</h2>
            <p className="text-gray-400">Stay connected with the latest additions to our family collection</p>
          </div>
